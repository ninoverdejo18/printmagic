    ...
    >
        ...
        {categories.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 cursor-pointer focus:outline-none ${
              activeFilter === cat.id
                ? "bg-[#108c1d] hover:bg-[#0d7018] text-white font-bold border border-[#108c1d] hover:border-[#0d7018] shadow-sm"
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 sm:p-10 text-center space-y-4 w-full mt-6 shadow-xl text-white">
        ...
        <button
          ...
          className="px-8 py-3 bg-[#108c1d] hover:bg-[#0d7018] text-white border border-[#108c1d] hover:border-[#0d7018] rounded-lg font-bold shadow-md hover:opacity-95 transition-all flex items-center justify-center mx-auto cursor-pointer"
          id="quote-design-btn"
        >
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="pt-4 border-t border-slate-200 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-lg bg-[#108c1d] hover:bg-[#0d7018] text-white border border-[#108c1d] hover:border-[#0d7018] font-bold text-xs shadow-md transition-all cursor-pointer inline-flex items-center"
                  >
